...
欢迎来到我的[跑步主页](https://jinlei.run/)，这是一个基于@yihong0618 优秀的开源项目:[running page](https://github.com/yihong0618/running_page)构建的小项目

- ⌚️ 跑步装备是：Apple Watch Series 9 
- 📱 运动app：Apple Watch自带训练 App
- 🏃🏻‍♂️ 数据流是：Apple Watch-> Codoon-> running page
